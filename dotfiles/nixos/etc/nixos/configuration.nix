...
# in
{
  ...
  # home-manager.uesUserPackages = true;
  # home-manager.useGlobalPkgs = true;
  # home-manager.backupFileExtentsion = "backup";
  # home-manager.users.steveng = import ./home.nix;
  ...
  networking.hostName = "pop-os"; # Define your hostname.
